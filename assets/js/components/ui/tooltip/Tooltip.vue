...
const contentClasses = computed(() =>
  twMerge(
    [
      'z-50 m-0 w-max max-w-[calc(100vw-1rem)] rounded-md border border-gray-950 bg-gray-950 px-2.5 py-1.5 text-xs font-medium leading-none text-white shadow-md outline-none dark:border-gray-100 dark:bg-gray-100 dark:text-gray-950',
  ...
  >
    ...
    >
      ...
      <span
        ...
        class="size-2 forced-colors:hidden absolute -z-10 rotate-45 border border-inherit bg-inherit"
        :style="arrowStyle"
      />
    </div>
  </span>
