    ...
    <div class="flex-1 overflow-y-auto px-4 py-6 sm:px-8 sm:py-8">
      <div class="mx-auto max-w-6xl">
          ...
          <div class="divide-y divide-gray-200 rounded-b-lg bg-white dark:divide-gray-800 dark:bg-gray-950">
            ...
            >
              ...
              <div class="col-span-3">
                <template v-if="renamingId === token.id">
                  <div class="flex items-center space-x-2">
                    <input
                      ...
                      ref="renameInput"
                      autofocus
                      class="w-full rounded-md border border-gray-200 bg-white px-2 py-1 text-sm text-gray-900 focus:border-brand focus:outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-white"
                    />
                    <button
                ...
                <template v-else>
                  <div class="flex items-center space-x-2">
                    <svg class="h-4 w-4 text-green-600 dark:text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div v-else class="rounded-lg border border-dashed border-gray-300 px-6 py-12 text-center dark:border-gray-700">
          ...
          <p class="mt-3 text-sm text-gray-500 dark:text-gray-400">No CLI keys yet.</p>
          <p class="mt-1 text-sm text-gray-400 dark:text-gray-500">
            Log in with the CLI to create one: <code class="rounded bg-gray-100 px-1.5 py-0.5 text-xs dark:bg-gray-800">slipway login</code>
          </p>
        </div>
      </div>
    </div>
