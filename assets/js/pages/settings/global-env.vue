  ...
  <div class="flex h-full flex-col">
    ...
    <div class="flex items-center justify-between border-b border-gray-200 py-4 pl-4 pr-4 dark:border-gray-800 sm:pl-4 sm:pr-8">
      <div class="flex items-center space-x-3">
        ...
        <nav class="flex items-center space-x-2 text-sm">
          ...
          <span class="font-medium text-gray-900 dark:text-white">global environment</span>
        </nav>
      </div>
    ...
    <div class="flex-1 overflow-y-auto px-4 py-6 sm:px-8 sm:py-8">
      <div class="mx-auto max-w-6xl">
        <!-- Description -->
        <div class="mb-6">
          <h1 class="text-xl font-semibold text-gray-900 dark:text-white">Global Environment Variables</h1>
          <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Instance-wide variables automatically injected into all deployed applications. Per-environment variables override these.
          </p>
        </div>
        ...
        <div class="mb-6">
          <div :class="[
            ...
            <svg v-if="backupConfigured" class="h-4 w-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <span :class="['text-sm', backupConfigured ? 'text-green-700 dark:text-green-400' : 'text-gray-500 dark:text-gray-400']">
              {{ backupConfigured ? 'Backup storage configured' : 'Set R2_ACCESS_KEY, R2_SECRET_KEY, R2_BUCKET, and R2_ENDPOINT to enable database backups' }}
            </span>
          </div>
        </div>
        ...
        <div class="rounded-lg border border-gray-200 dark:border-gray-800">
          ...
          <div class="flex items-center justify-between px-4 py-3">
            <h2 class="text-sm font-medium text-gray-900 dark:text-white">Variables</h2>
        ...
        <div class="mt-8 rounded-lg border border-gray-200 dark:border-gray-800">
          <div class="px-4 py-3">
            <h2 class="text-sm font-medium text-gray-900 dark:text-white">Common variables</h2>
          </div>
          <div class="divide-y divide-gray-200 border-t border-gray-200 dark:divide-gray-800 dark:border-gray-800">
            <div class="px-4 py-3">
              <p class="text-sm font-medium text-gray-700 dark:text-gray-300">Cloudflare R2 / S3-Compatible Storage</p>
              <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">Used for file uploads and database backups</p>
              <div class="mt-2 rounded bg-gray-50 px-3 py-2 font-mono text-xs text-gray-600 dark:bg-gray-900 dark:text-gray-400">
                R2_ACCESS_KEY, R2_SECRET_KEY, R2_BUCKET, R2_ENDPOINT
              </div>
            </div>
            <div class="px-4 py-3">
              <p class="text-sm font-medium text-gray-700 dark:text-gray-300">Email (SMTP)</p>
              <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">For transactional email via Sails Mail SMTP transport</p>
              <div class="mt-2 rounded bg-gray-50 px-3 py-2 font-mono text-xs text-gray-600 dark:bg-gray-900 dark:text-gray-400">
