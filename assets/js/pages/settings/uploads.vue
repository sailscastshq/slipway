      ...
      <div class="mx-auto max-w-6xl">
        ...
        <form @submit.prevent="save" class="space-y-6">
          <div class="rounded-lg border border-gray-200 dark:border-gray-800">
            ...
            <div
              class="space-y-4 border-t border-gray-200 px-4 py-4 dark:border-gray-800"
            >
              <!-- Access Key -->
              <div>
                <label
                ...
                >
                  ...
                  <span
                    v-if="
                      isCurrentProvider &&
                      (selectedProvider === 'r2'
                        ? props.config.r2AccessKey
                        : selectedProvider === 's3'
                        ? props.config.s3AccessKey
                        : props.config.spacesAccessKey)
                    "
                    class="text-gray-400"
                  >
                    (current:
              ...
              <div
                v-if="
                  selectedProvider === 's3' || selectedProvider === 'spaces'
                "
              >
                <label
                  class="mb-1 block text-xs font-medium text-gray-500 dark:text-gray-400"
              ...
              <div>
                ...
                >
                  Endpoint
                  <span v-if="selectedProvider === 's3'" class="text-gray-400"
        ...
        >
          ...
          >
            <div class="flex items-center justify-between">
              <div>
                <span
                  ...
                  >Enable scheduled backups</span
                >
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  When enabled, all running database services will be backed up
                  automatically.
                </p>
              </div>
              <button
            ...
            <div
              v-if="scheduleForm.backupSchedule.enabled"
        ...
        >
          ...
          <div
            class="divide-y divide-gray-200 border-t border-gray-200 text-sm dark:divide-gray-800 dark:border-gray-800"
          >
            <div class="flex items-start gap-3 px-4 py-3">
              <Image class="mt-0.5 h-4 w-4 shrink-0 text-gray-400" />
              <div>
                <span class="font-medium text-gray-700 dark:text-gray-300"
                  >Team logos</span
                >
                <p class="text-gray-500 dark:text-gray-400">
                  Upload and display your team's logo in the sidebar
                </p>
              </div>
            </div>
            <div class="flex items-start gap-3 px-4 py-3">
              <Database class="mt-0.5 h-4 w-4 shrink-0 text-gray-400" />
              <div>
                <span class="font-medium text-gray-700 dark:text-gray-300"
                  >Database backups</span
                >
                <p class="text-gray-500 dark:text-gray-400">
                  Automatic PostgreSQL backups for your managed services
                </p>
              </div>
            </div>
          </div>
