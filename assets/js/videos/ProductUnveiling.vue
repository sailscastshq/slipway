...
function useScene(name) {
  ...
  const progress = computed(() =>
    Math.min(1, Math.max(0, (frame.value - s.start) / s.dur))
  )
  const isActive = computed(
    () => frame.value >= s.start && frame.value < s.start + s.dur
  )
...
const whatifLine1Opacity = computed(() =>
  interpolate(whatif.localFrame.value, [0, 25], [0, 1], {
    easing: Easing.easeOut,
    extrapolateRight: 'clamp'
  })
)
const whatifLine2Opacity = computed(() =>
  interpolate(whatif.localFrame.value, [50, 80], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
const whatifLine2Y = computed(() =>
  interpolate(whatif.localFrame.value, [50, 80], [40, 0], {
    easing: Easing.easeOut,
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
...
const whatifFadeOut = computed(() =>
  interpolate(whatif.progress.value, [0.8, 1], [1, 0], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
...
const slippyScale = computed(() => {
  ...
  if (f < 20)
    return interpolate(f, [0, 20], [0.2, 1.15], {
      easing: Easing.easeOut,
      extrapolateRight: 'clamp'
    })
  return interpolate(f, [20, 35], [1.15, 1], {
    easing: Easing.easeOut,
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
...
const slippyOpacity = computed(() =>
  interpolate(slippy.localFrame.value, [0, 10], [0, 1], {
    easing: Easing.easeOut,
    extrapolateRight: 'clamp'
  })
)
const slippyBob = computed(() =>
  slippy.localFrame.value > 40
    ? Math.sin((slippy.localFrame.value - 40) / 18) * 10
    : 0
)
const winkEye = computed(() => {
  const f = slippy.localFrame.value
  if (f < 60 || f > 90) return 1
  return interpolate(f, [60, 70, 80, 90], [1, 0.05, 0.05, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
})
const slippyLabelOp = computed(() =>
  interpolate(slippy.localFrame.value, [35, 55], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
const slippyLabelY = computed(() =>
  interpolate(slippy.localFrame.value, [35, 55], [25, 0], {
    easing: Easing.easeOut,
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
...
const slippyFadeOut = computed(() =>
  interpolate(slippy.progress.value, [0.75, 1], [1, 0], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
function tentRot(index) {
  return computed(
    () => Math.sin((frame.value + index * 40) / 18) * (10 + index * 3)
  )
}
const t1 = tentRot(0),
  t2 = tentRot(1),
...
const brandTitleScale = computed(() =>
  interpolate(brand.localFrame.value, [0, 40], [0.4, 1], {
    easing: Easing.easeOut,
    extrapolateRight: 'clamp'
  })
)
const brandTitleOpacity = computed(() =>
  interpolate(brand.localFrame.value, [0, 25], [0, 1], {
    easing: Easing.easeOut,
    extrapolateRight: 'clamp'
  })
)
const brandTagOpacity = computed(() =>
  interpolate(brand.localFrame.value, [70, 100], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
const brandTagY = computed(() =>
  interpolate(brand.localFrame.value, [70, 100], [30, 0], {
    easing: Easing.easeOut,
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
...
const brandFadeOut = computed(() =>
  interpolate(brand.progress.value, [0.8, 1], [1, 0], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
...
const probLine1Op = computed(() =>
  interpolate(problem.localFrame.value, [0, 20], [0, 1], {
    easing: Easing.easeOut,
    extrapolateRight: 'clamp'
  })
)
const probLine2Op = computed(() =>
  interpolate(problem.localFrame.value, [40, 60], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
const probLine2Scale = computed(() =>
  interpolate(problem.localFrame.value, [40, 60], [1.2, 1], {
    easing: Easing.easeOut,
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
...
function probItemStyle(i) {
  ...
  return {
    opacity: opacity * probFadeOut.value,
    transform: `translateX(${x}px)`
  }
}
const probFadeOut = computed(() =>
  interpolate(problem.progress.value, [0.8, 1], [1, 0], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
...
const slideLabelOp = computed(() =>
  interpolate(slide.localFrame.value, [0, 20], [0, 1], {
    easing: Easing.easeOut,
    extrapolateRight: 'clamp'
  })
)
const slideTitleOp = computed(() =>
  interpolate(slide.localFrame.value, [10, 35], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
const slideTitleY = computed(() =>
  interpolate(slide.localFrame.value, [10, 35], [50, 0], {
    easing: Easing.easeOut,
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
...
const slideTermOp = computed(() =>
  interpolate(slide.localFrame.value, [50, 70], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
const slideTermY = computed(() =>
  interpolate(slide.localFrame.value, [50, 70], [40, 0], {
    easing: Easing.easeOut,
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
...
const slideCmdChars = computed(() => {
  ...
  return Math.min(
    Math.floor((slide.localFrame.value - 80) * 0.5),
    slideCmdText.length
  )
})
const slideCmdCursor = computed(
  () =>
    slideCmdChars.value < slideCmdText.length &&
    Math.floor(slide.localFrame.value / 8) % 2 === 0
)
// Deploy output lines
const slideOutput = [
  'Building image...',
  'Health check passed.',
  'Traffic switched. Live.'
]
function slideOutputStyle(i) {
  const base = 110 + slideCmdText.length * 2
  const delay = base + i * 20
  const opacity = interpolate(
    slide.localFrame.value,
    [delay, delay + 12],
    [0, 1],
...
const slideDescOp = computed(() =>
  interpolate(slide.localFrame.value, [60, 85], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
const slideFadeOut = computed(() =>
  interpolate(slide.progress.value, [0.85, 1], [1, 0], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
...
function svcWordStyle(i) {
  ...
  return {
    opacity: opacity * svcFadeOut.value,
    transform: `translateY(${y}px)`
  }
}
const svcOneClickOp = computed(() =>
  interpolate(services.localFrame.value, [90, 110], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
const svcOneClickScale = computed(() =>
  interpolate(services.localFrame.value, [90, 110], [0.8, 1], {
    easing: Easing.easeOut,
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
...
const svcDescOp = computed(() =>
  interpolate(services.localFrame.value, [120, 145], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
const svcFadeOut = computed(() =>
  interpolate(services.progress.value, [0.8, 1], [1, 0], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
...
const lookoutTitleOp = computed(() =>
  interpolate(lookout.localFrame.value, [0, 25], [0, 1], {
    easing: Easing.easeOut,
    extrapolateRight: 'clamp'
  })
)
const lookoutTitleScale = computed(() =>
  interpolate(lookout.localFrame.value, [0, 25], [0.85, 1], {
    easing: Easing.easeOut,
    extrapolateRight: 'clamp'
  })
)
const lookoutDescOp = computed(() =>
  interpolate(lookout.localFrame.value, [40, 65], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
const lookoutDescY = computed(() =>
  interpolate(lookout.localFrame.value, [40, 65], [30, 0], {
    easing: Easing.easeOut,
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
...
const lookoutFadeOut = computed(() =>
  interpolate(lookout.progress.value, [0.8, 1], [1, 0], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
...
const toolsTitleOp = computed(() =>
  interpolate(tools.localFrame.value, [0, 25], [0, 1], {
    easing: Easing.easeOut,
    extrapolateRight: 'clamp'
  })
)
const toolsSubOp = computed(() =>
  interpolate(tools.localFrame.value, [20, 45], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
const toolsFadeOut = computed(() =>
  interpolate(tools.progress.value, [0.8, 1], [1, 0], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
...
const openTitleOp = computed(() =>
  interpolate(open.localFrame.value, [0, 30], [0, 1], {
    easing: Easing.easeOut,
    extrapolateRight: 'clamp'
  })
)
const openTitleScale = computed(() =>
  interpolate(open.localFrame.value, [0, 30], [0.8, 1], {
    easing: Easing.easeOut,
    extrapolateRight: 'clamp'
  })
)
const openSubOp = computed(() =>
  interpolate(open.localFrame.value, [35, 55], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
...
const cmdChars = computed(() => {
  ...
  return Math.min(
    Math.floor((open.localFrame.value - 80) * 0.8),
    cmdText.length
  )
})
const cmdCursor = computed(
  () =>
    cmdChars.value < cmdText.length &&
    Math.floor(open.localFrame.value / 8) % 2 === 0
)
const cmdOpacity = computed(() =>
  interpolate(open.localFrame.value, [60, 80], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
const openFadeOut = computed(() =>
  interpolate(open.progress.value, [0.85, 1], [1, 0], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
...
const ctaTitleOp = computed(() =>
  interpolate(cta.localFrame.value, [0, 35], [0, 1], {
    easing: Easing.easeOut,
    extrapolateRight: 'clamp'
  })
)
const ctaTitleScale = computed(() =>
  interpolate(cta.localFrame.value, [0, 35], [0.85, 1], {
    easing: Easing.easeOut,
    extrapolateRight: 'clamp'
  })
)
const ctaBtnOp = computed(() =>
  interpolate(cta.localFrame.value, [60, 85], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
const ctaBtnY = computed(() =>
  interpolate(cta.localFrame.value, [60, 85], [30, 0], {
    easing: Easing.easeOut,
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
...
const ctaFadeOut = computed(() =>
  interpolate(cta.progress.value, [0.85, 1], [1, 0], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
...
const finSlippyOp = computed(() =>
  interpolate(finale.localFrame.value, [0, 40], [0, 1], {
    easing: Easing.easeOut,
    extrapolateRight: 'clamp'
  })
)
const finSlippyScale = computed(() => {
  ...
  if (f < 25)
    return interpolate(f, [0, 25], [0.3, 1.08], {
      easing: Easing.easeOut,
      extrapolateRight: 'clamp'
    })
  return interpolate(f, [25, 40], [1.08, 1], {
    easing: Easing.easeOut,
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
...
const finBob = computed(() =>
  finale.localFrame.value > 50
    ? Math.sin((finale.localFrame.value - 50) / 22) * 8
    : 0
)
const finNameOp = computed(() =>
  interpolate(finale.localFrame.value, [50, 80], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
const finNameScale = computed(() =>
  interpolate(finale.localFrame.value, [50, 80], [0.9, 1], {
    easing: Easing.easeOut,
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
...
const finTagOp = computed(() =>
  interpolate(finale.localFrame.value, [100, 130], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
const finUrlOp = computed(() =>
  interpolate(finale.localFrame.value, [150, 180], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp'
  })
)
...
<template>
  <div class="video" :style="{ background: bgColor }">
    <!-- ═══ SCENE 1: What if... (white bg) ═══ -->
    <div
      v-if="whatif.isActive.value"
      class="scene center col"
      :style="{ opacity: whatifFadeOut }"
    >
      <p class="whatif-line1" :style="{ opacity: whatifLine1Opacity }">
        What if...
      </p>
      <p
        class="whatif-line2"
        :style="{
          opacity: whatifLine2Opacity,
          transform: `translateY(${whatifLine2Y}px)`
        }"
      >
    ...
    <!-- ═══ SCENE 2: Slippy entrance (dark bg) ═══ -->
    <div
      v-if="slippy.isActive.value"
      class="scene center col"
      :style="{ opacity: slippyFadeOut }"
    >
      <svg
        viewBox="0 0 32 32"
        fill="none"
      ...
      <p
        class="slippy-label"
        :style="{
          opacity: slippyLabelOp * slippyFadeOut,
          transform: `translateY(${slippyLabelY}px)`
        }"
      >
        Meet Slippy.
      </p>
    ...
    <div
      v-if="brand.isActive.value"
      class="scene center col"
      :style="{ opacity: brandFadeOut }"
    >
      <h1
        class="brand-title"
        :style="{
    ...
    <div v-if="problem.isActive.value" class="scene center col">
      ...
      <div class="prob-items">
        <span
          v-for="(item, i) in probItems"
          :key="i"
          class="prob-item"
          :style="probItemStyle(i)"
        >
          {{ item }}
        </span>
      </div>
    ...
    <!-- ═══ SCENE 5: slipway slide — HERO (white bg) ═══ -->
    <div
      v-if="slide.isActive.value"
      class="scene"
      :style="{ opacity: slideFadeOut }"
    >
      <div class="slide-left">
        <span class="slide-label" :style="{ opacity: slideLabelOp }"
          >DEPLOY</span
        >
        <h2
          class="slide-title"
          :style="{
            opacity: slideTitleOp,
            transform: `translateY(${slideTitleY}px)`
          }"
        >
      ...
      <div class="slide-right">
        <div
          ...
          :style="{
            opacity: slideTermOp,
            transform: `translateY(${slideTermY}px)`
          }"
        >
          <div class="term-header">
            <div class="tdot red" />
            <div class="tdot yellow" />
            <div class="tdot green" />
          </div>
          <div class="term-body">
            <div class="term-line">
              <span class="ttext">{{
                slideCmdText.slice(0, slideCmdChars)
              }}</span>
              <span v-if="slideCmdCursor" class="tcursor-dark">|</span>
            </div>
            <div
              v-for="(line, i) in slideOutput"
              :key="i"
              class="term-output"
              :style="slideOutputStyle(i)"
            >
    ...
    <div v-if="services.isActive.value" class="scene center col">
      <div class="svc-words">
        <span
          v-for="(word, i) in svcWords"
          :key="i"
          class="svc-word"
          :style="svcWordStyle(i)"
          >{{ word }}</span
        >
      </div>
      <p
    ...
    <!-- ═══ SCENE 7: Lookout (white bg) ═══ -->
    <div
      v-if="lookout.isActive.value"
      class="scene center col"
      :style="{ opacity: lookoutFadeOut }"
    >
      <h2
        class="lookout-title"
        :style="{
    ...
    <div v-if="tools.isActive.value" class="scene center col">
      <h2 class="tools-title" :style="{ opacity: toolsTitleOp * toolsFadeOut }">
        Everything you need.
      </h2>
      <p class="tools-sub" :style="{ opacity: toolsSubOp * toolsFadeOut }">
        Nothing you don't.
      </p>
      <div class="tools-grid">
        <div
          ...
          :key="i"
          class="tool-card"
          :style="{ ...toolCardStyle(i), borderColor: `${tool.color}40` }"
        >
    ...
    <!-- ═══ SCENE 9: Open Source (dark bg) ═══ -->
    <div
      v-if="open.isActive.value"
      class="scene center col"
      :style="{ opacity: openFadeOut }"
    >
      <h2
        class="open-title"
        :style="{ opacity: openTitleOp, transform: `scale(${openTitleScale})` }"
      >
        100% Open Source.
      </h2>
      <p class="open-sub" :style="{ opacity: openSubOp }">
    ...
    <!-- ═══ SCENE 10: CTA (white bg) ═══ -->
    <div
      v-if="cta.isActive.value"
      class="scene center col"
      :style="{ opacity: ctaFadeOut }"
    >
      <h2
        class="cta-title"
        :style="{
      ...
      <div
        class="cta-btn"
        :style="{ opacity: ctaBtnOp, transform: `translateY(${ctaBtnY}px)` }"
      >
        Get Started
      </div>
      <p class="cta-url" :style="{ opacity: ctaBtnOp }">
        docs.sailscasts.com/slipway
      </p>
    </div>
    ...
    <div v-if="finale.isActive.value" class="scene center col">
      ...
      <h1
        class="fin-wordmark"
        :style="{ opacity: finNameOp, transform: `scale(${finNameScale})` }"
      >
        Slipway
      </h1>
      <p class="fin-tag" :style="{ opacity: finTagOp }">
        Your apps. Your server. Your rules.
      </p>
      <p class="fin-url" :style="{ opacity: finUrlOp }">
        docs.sailscasts.com/slipway
      </p>
    </div>
  </div>
