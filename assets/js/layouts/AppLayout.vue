...
const isActive = (path) => {
  if (path === '/') {
    ...
    return currentPath.value === '/' || (currentPath.value.startsWith('/projects') && !currentPath.value.includes('/lookout'))
  }
  if (path === '/lookout') {
    return currentPath.value.startsWith('/lookout') || currentPath.value.includes('/lookout')
  }
