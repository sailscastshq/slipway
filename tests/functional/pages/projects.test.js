...
test('genesis user can open the new project page', async ({
  sails,
  expect
}) => {
...
test('genesis user can create a project, environment, and app', async ({
  sails,
  expect
}) => {
  ...
  const environmentPage = await inertia.get(
